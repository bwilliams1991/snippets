...
router.get('/scrape', function (req, res) {
	...
	request('https://www.lean.org/LeanPost/', function (error, response, html) {
		...
		$('div .postblock').each(function (i, element) {
			...
			// they separated the types of articles; and they are structured differently.... Or?
			result.title = $(this).children('.overlaycontentsmedium').children('.itemlinkshomemedium').children('.titlemedium').attr("title") || $(this).children('.katainfo').children('a').attr("title");

			result.link ='https://www.lean.org' + $(this).children('.overlaycontentsmedium').children('.itemlinkshomemedium').children('.titlemedium').attr("href")  || 'https://www.lean.org' + $(this).children('.katainfo').children('a').attr("href");
