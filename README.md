# The Lean Post Scraper
A `Node.js` &amp; `MongoDB` webapp that web-scrapes news data from [The Lean Post](https://www.lean.org/LeanPost/) and allows users to comment about what they have read. Users can also delete unwanted comments.

Please check out the deployed version in Heroku [here](https://snippetsbw.herokuapp.com/)!
